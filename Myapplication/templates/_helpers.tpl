...
{{ include "Myapplication.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "Myapplication.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "Myapplication.fullname" .) .Values.serviceAccount.name }}
{{- else }}
